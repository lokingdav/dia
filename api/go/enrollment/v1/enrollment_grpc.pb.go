...
const (
	EnrollmentService_EnrollSubscriber_FullMethodName = "/denseid.enrollment.v1.EnrollmentService/EnrollSubscriber"
)
...
var EnrollmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "denseid.enrollment.v1.EnrollmentService",
